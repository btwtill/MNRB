    ...
    def onMirrorNode(self):
        ...
        for index, node_data in enumerate(data["nodes"]):
            ...
            if node_old_side_prefix == ROSE_Names.left.prefix:
                node_data['properties']['component_side_prefix'] = ROSE_Names.right.prefix
            elif node_old_side_prefix == ROSE_Names.right.prefix:
                node_data['properties']['component_side_prefix'] = ROSE_Names.left.prefix
