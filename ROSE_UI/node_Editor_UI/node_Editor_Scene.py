...
from MNRB.ROSE_UI.node_Editor_UI.node_Editor_SceneProperties import NodeEditorSceneProperties #type: ignore
...
class NodeEditorScene(Serializable):
    def __init__(self):
        ...
        self.virtual_rig_hierarchy = ROSE_Virtual_Hierarchy(self)

        self.colors = ROSESceneColors(self)
