...
from MNRB.ROSE_UI.skinning_Editor_UI.skinning_Editor_DeformList import SkinningEditorDeformList #type: ignore
from MNRB.ROSE_UI.skinning_Editor_UI.skinning_Editor_Toolbar import SkinningEditorToolbar #type: ignore
from MNRB.ROSE_UI.skinning_Editor_UI.skinning_Editor_Cluster import SkinningEditorCluster #type: ignore
...
class rose_SkinningEditorTab(QWidget, Serializable):
    def __init__(self, node_editor, parent=None):
        ...
        #mirrors how the node graph's undo history triggers rose_editor.py's
    ...
    def onOpenFile(self, file_Path):
        #file_Path here is the project's rose_skinning_editor folder itself (see
        #rose_editor.py's onOpenProject), which is exactly the folder weight files
        #belong under
    ...
    #the Edit menu (rose_editor.py:updateEditMenu) generically calls these on
