...
from MNRB.ROSE_UI.rose_ui_utils import getMayaWindow # type: ignore
from MNRB.ROSE_UI.rose_nodeEditorTab import rose_NodeEditorTab # type: ignore
...
class rose_Editor(QtWidgets.QMainWindow):
    def __init__(self, parent = getMayaWindow()):
        ...
        self.rose_path = os.path.join(self.working_directory, self.project_settings['ProjectSubPath'], "ROSE")

        self._project_path = None
        self._project_name = None
        self.rose_base_editor_path_name = "rose_editor"
        self.rose_base_editor_path = None
        self.rose_skinning_editor_path_name = "rose_skinning_editor"
    ...
    def setupNodeEditorTab(self):
        ...
        self.nodeEditorTabWindow = rose_NodeEditorTab()
        ...
        self.tabs.addTab(first_tab_container, "ROSE")

    def setupSkinEditorTab(self):
        # Skining tab PlaceHolder Widget
        self.skinningEditorTabWindow = rose_SkinningEditorTab(self.nodeEditorTabWindow)
    ...
    def setupProjectOverlay(self):
        ...
        current_workspace_projects = os.listdir(self.rose_path)
        ...
        for item in current_workspace_projects:
            ...
            new_poject_list_item.setText(item + " - " + os.path.join(self.rose_path, item))
        ...
        overlay_title = QtWidgets.QLabel("ROSE - Editor")
    ...
    def createEditorActions(self):
        ...
        self.action_about = QAction('&About', self, shortcut = '', statusTip='information about ROSE', triggered=self.onAbout)
    ...
    def setupNodeEditorMenu(self, menu_bar):
        self.node_editor_menu = menu_bar.addMenu('&ROSE')
    ...
    def onNewProjectFromMenuBar(self):
        ...
        new_project_name_messageBox.setWindowTitle("Please give your new ROSE Project a Title!")
    ...
    def onNewProject(self, name):
        if self.projectNeedsSaving():
            if self.validateProjectName(name):
                ...
                #create Project
                self.project_path = os.path.join(self.rose_path, name)
                os.mkdir(self.project_path)

                #creating The Project Hirarchy
                if self.rose_base_editor_path:
                    os.mkdir(self.rose_base_editor_path)
                if self.rose_skinning_editor_path:
    ...
    def onSaveProjectAs(self):
        ...
        if directory_name != '':
            ...
            if os.path.isdir(directory_path):
                ...
                self.getNodeEditorTab().onSaveFile(os.path.join(self.rose_base_editor_path, self.project_name + "_graph")) # type: ignore
    ...
    def onAbout(self):
        ...
        about_menu_messageBox.setWindowTitle("ROSE Information")
    ...
    def setTitleText(self):
        ...
        if self.project_name is not None:
            ...
            self.setWindowTitle("ROSE Editor - Undefined")
    ...
    def validateProjectName(self, name):
        rose_projects = os.listdir(self.rose_path)
        if name == "": 
            return False
        elif name in rose_projects :
            return False
        else:
            return True
