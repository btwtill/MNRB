...
class ROSE_Names():
    ...
    right = ROSE_Side("right", "R_")
    middle = ROSE_Side("middle", "M_")
    ...
    guide_material_suffix = "_lambert_ROSE_guide_material"
    guide_shader_suffix = "_lambert_ROSE_guide_shader_SG"
