...
class ROSE_Virtual_Hierarchy():
    def __init__(self, scene) -> None:
        ...
        self.guide_hierarchy_suffix = ROSE_Names.guide_hierarchy_suffix
        self.rig_hierarchy_suffix = ROSE_Names.rig_hierarchy_suffix
        self.components_hiearchy_suffix = ROSE_Names.rig_hierarchy_component_suffix
        self.skeleton_hiearchy_suffix = ROSE_Names.rig_hierarchy_skeleton_suffix
        self.geometry_hiearchy_suffix = ROSE_Names.rig_hierarchy_geometry_suffix
        self.shapes_hiearchy_suffix = ROSE_Names.rig_hierarchy_shapes_suffix
    ...
    def initHierarchy(self):
        self.guide_hierarchy_object = VirtualHierarchyObject(self, suffix = ROSE_Names.guide_hierarchy_suffix)
