...
from MNRB.ROSE_Nodes.property_UI_GraphicComponents.side_button import MirroringSidePrefixButton #type: ignore
from MNRB.ROSE_Nodes.property_UI_GraphicComponents.receit_widget import ReceitWidget #type: ignore
...
class ROSE_NodeProperties(NodeEditorNodeProperties):
    def __init__(self, node):
        ...
        self.component_side_prefix = ROSE_Names.middle.prefix
        self.component_color = ROSEColor.yellow
    ...
    def initUI(self):
        ...
        self.left_prefix_button = MirroringSidePrefixButton(self, ROSE_Names.left.side, ROSE_Names.left.prefix)
        self.mid_prefix_button = MirroringSidePrefixButton(self, ROSE_Names.middle.side, ROSE_Names.middle.prefix)
        self.right_prefix_button = MirroringSidePrefixButton(self, ROSE_Names.right.side, ROSE_Names.right.prefix)
    ...
    def onBuildStep(self):
        ...
        if build_stage == ROSE_Names.build_step.static:
            self.onBuildStatic()
        elif build_stage == ROSE_Names.build_step.component:
    ...
    def deserialize(self, data, hashmap = {}, restore_id=True):
        ...
        self.component_color = ROSESceneColors.mapColorNameToColor(data['component_color'])
        self.component_color_dropdown.setCurrentText(data['component_color'])

        self.component_side_prefix = data['component_side_prefix']
        if data['component_side_prefix'] == ROSE_Names.left.prefix:
            self.left_prefix_button.mark()
        elif data['component_side_prefix'] == ROSE_Names.right.prefix:
...
class ROSE_Node(NodeEditorNode):
    ...
    def componentBuild(self, rebuild_static = True):
        ...
        component_hierarchy = self.getComponentPrefix() + self.getComponentName() + ROSE_Names.component_suffix
        ...
        self.output_hierarchy = MC.createTransform(self.getComponentPrefix() + self.getComponentName() + ROSE_Names.output_hierarchy_suffix)
        ...
        self.system_hierarchy = MC.createTransform(self.getComponentPrefix() + self.getComponentName() + ROSE_Names.system_hierarchy_suffix)
        ...
        self.control_hierarchy = MC.createTransform(self.getComponentPrefix() + self.getComponentName() + ROSE_Names.control_hierarchy_suffix)
    ...
    def validateComponentIdLink(self, object):
        component_id_attribute = MC.getAttribute(object, ROSE_Names.component_id_attribute_name)
