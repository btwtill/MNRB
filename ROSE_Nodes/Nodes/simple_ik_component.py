...
class ROSE_Node_SimpleIKComponent(ROSE_NodeTemplate):
    ...
    Node_Properties_Class = ROSE_Node_SimpleIKComponent_Properties
    ...
    def componentBuild(self):
        ...
        # Create Main Inputs
        # Base Input
        self.base_input = MC.createTransform(self.getComponentFullPrefix() + "base" + ROSE_Names.input_suffix)
        ...
        # End Input
        self.end_input = MC.createTransform(self.getComponentFullPrefix() + "end" + ROSE_Names.input_suffix)
        ...
        base_output = MC.createTransform(self.getComponentFullPrefix() + "base" + ROSE_Names.output_suffix)
        ...
        pole_output = MC.createTransform(self.getComponentFullPrefix() + "pole" + ROSE_Names.output_suffix)
        ...
        end_output = MC.createTransform(self.getComponentFullPrefix() + "end" + ROSE_Names.output_suffix)
