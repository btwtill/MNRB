...
from MNRB.MNRB_UI.pipeline_Editor_UI.pipeline_Editor_Widget import PipelineEditorWidget #type: ignore

CLASS_DEBUG = False

class mnrb_PipelineEditorTab(QtWidgets.QMainWindow):
    """Mirrors mnrb_nodeEditorTab.py's shape for the pipeline canvas - no left-dock
    ...
    def loadFile(self, path):
        try:
            ...
            print("mnrb_PipelineEditorTab:: --loadFile:: Failed to load '%s': %s - starting a blank pipeline instead" % (path, e))
            self.onNewFile()
