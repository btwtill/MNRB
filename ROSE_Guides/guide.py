...
from MNRB.ROSE_Guides.ROSE_Guide_Shapes.locator_guide_shape import LocatorGuideShape #type: ignore
from MNRB.ROSE_Guides.ROSE_Guide_Shapes.nurbs_shpere_guide_shape import NurbsShereGuideShape #type: ignore
from MNRB.ROSE_Guides.ROSE_Up_Shapes.nurbs_up_guide_shape import NurbsShereUpGuideShape #type:ignore
from MNRB.ROSE_Guides.ROSE_Up_Shapes.locator_up_guide_shape import LocatorUpGuideShape #type:ignore
from MNRB.ROSE_Guides.ROSE_Orientation_Shapes.nurbs_orient_guide_shape import NurbsShereOrientGuideShape #type:ignore
from MNRB.ROSE_Guides.ROSE_Orientation_Shapes.locator_orient_guide_shape import LocatorOrientGuideShape #type:ignore
...
class guide(Serializable):
    ...
    def assembleFullName(self):
        return self.node.getComponentPrefix() + self.node.getComponentName() + "_" + self.guide_name + ROSE_Names.guide_suffix
